		...
		<div class="container py-3">
           <form action="compra-update">
				...
				<div class="form-group mb-3">
					...
					<select id="passagem" name="passagem" class="form-control">
						<option value="DEFAULT">${compra.passagem.destino}</option>
				...
				<div class="form-group mb-3">
					...
					<select id="usuario" name="usuario" class="form-control">
						<option value="DEFAULT">${compra.usuario.destino}</option>
